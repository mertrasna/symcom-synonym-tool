...
$get_data = '';
$response = [];
$get_data = callAPI('GET', $baseApiURL.'synonym-de/all?is_paginate=0', false);
			...
			<div class="col-md-12">
				<div class="box box-success">
		            ...
		            <div class="box-header with-border">
						<h3 class="box-title">
							<a href="<?php echo $absoluteUrl;?>stammdaten/synonym-de/add" class="btn btn-success"><i class="fa fa-plus"></i> &nbsp; Neues Synonym</a>
						</h3>
		            </div>
		            <?php  } ?>
		            <!-- /.box-header -->
		            <div class="box-body">
			            <form id="listViewForm" data-action="delete" data-source="synonym-de" data-source_id_name="synonym_id">
		            		<div class="table-responsive">
					            <table id="dataTable" class="table-loader table table-bordered table-striped display table-hover custom-table">
					                ...
					                <tbody data-link="row" class="rowlink">
					                	<?php 
					                	if($synonymDe != null && $synonymDe != '') { 
					                		foreach ($synonymDe as $key => $synon) { ?>
							                ...
							                <tr>
												...
												<td <?php if ($synon['synonym_ns']=="1") echo "class='ns_bg_color'"?>>
													<a href="#rowlinkModal" data-id="<?php echo $synon['synonym_id']; ?>" data-type="synonym_de" data-title="Synonym" data-toggle="modal"><?php echo $synon['word']; ?></a>
												</td>
												...
												<td class="rowlink-skip">
													<a class="btn btn-warning btn-sm" href="<?php echo $absoluteUrl;?>stammdaten/synonym-de/edit?synonym_id=<?php echo $synon['synonym_id']; ?>" title="Ändern"><i class="fa fa-edit"></i></a>
			            	       	            </td>
			            	       	            <?php  } ?>
							                </tr>
							            <?php } 
