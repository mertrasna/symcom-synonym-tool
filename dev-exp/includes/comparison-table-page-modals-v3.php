	    	...
	    	<form id="connect_edit_form" name="connect_edit_form" action="" method="POST">
		        ...
		        <div id="connect_edit_modal_container" class="modal-body">
					<div id="connect_edit_symptom_de_container" class="row">
	          			<div class="col-sm-12"><p><b>Symptom</b></p></div>
	          			<div class="col-sm-12">
	          				<textarea id="fv_symptom" name="fv_symptom" class="texteditor-small" aria-hidden="true"></textarea>
	          				<span class="fv-symptom-error error-text text-danger"></span>
	          			</div>
	          		</div>
		        </div>
		        <div class="modal-footer">
		        	<button type="button" class="btn btn-primary connect-edit-modal-submit-btn">Submit</button>
		          	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		        </div>
	    	</form>
	    </div>
		        ...
		        <div id="paste_edit_modal_container" class="modal-body">
					<div id="paste_edit_symptom_de_container" class="row">
	          			...
	          			<div class="col-sm-12">
	          				...
	          				<span class="fv-pe-symptom-error error-text text-danger"></span>
	          			</div>
	          		</div>
		        </div>
		        <div class="modal-footer">
		        	<button type="button" class="btn btn-primary paste-edit-modal-submit-btn">Submit</button>
		          	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		        </div>
	    	</form>
	    </div>
    ...
    <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	    	<form id="connect_edit_form" name="connect_edit_form" action="" method="POST">
		        ...
		        <div class="modal-footer">
		        	<button type="button" id="connect_edit_submit_btn" class="btn btn-primary connect-edit-modal-submit-btn">Submit</button>
		          	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		        </div>
	    	</form>
	    </div>
