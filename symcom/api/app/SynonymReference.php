...
class SynonymReference extends Model
{
    protected $table = 'synonym_reference';
     ...
     */
    protected $fillable = [
        'code', 'titel', 'comment', 'active', 'ip_address', 'stand', 'bearbeiter_id', 'ersteller_datum', 'ersteller_id'
    ];
    ...
    public function synonymDe()
    {
        return $this->belongsTo('App\SynonymDe');
    }
    
    public function synonymEn()
    {
        return $this->belongsTo('App\SynonymEn');
    }
