...
class SynonymEn extends Model
{
    protected $table = 'synonym_en';
    ...
    /**
     * The synonym reference that belong to the synonym en.
     */
    public function synonymReference()
    {
        return $this->belongsToMany('App\SynonymReference', 'synonym_en_synonym_reference', 'synonym_id', 'synonym_reference_id', 'synonym_id', 'synonym_reference_id');
    }
